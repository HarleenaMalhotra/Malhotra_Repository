...
MMData <- read_csv("/Users/Harleena/Documents/MSDS/FALL 2016/Data Wrangling and Husbandry/xmart.csv")
head(MMData)
glimpse(MMData)
summary(MMData)
```
...
```{r, warning=FALSE}
## Import income data
IncomeData <- read_csv("/Users/Harleena/Documents/MSDS/FALL 2016/Data Wrangling and Husbandry/IncomeData.csv", skip = 1)
head(IncomeData)
glimpse(IncomeData)
summary(IncomeData)
```
